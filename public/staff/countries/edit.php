...
$countries_result = find_country_by_id(db_escape($db, $_GET['id']));
...
if(is_post_request()) {
  ...
  if(isset($_POST['name'])) { $country['name'] = h(db_escape($db, $_POST['name'])); }
  if(isset($_POST['code'])) { $country['code'] = h(db_escape($db, $_POST['code'])); }
